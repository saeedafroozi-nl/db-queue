...
//
//
//         MSSQLServerContainer containerInstance = new MSSQLServerContainer()
//                .acceptLicense();
//
////        MSSQLServerContainer containerInstance = new MSSQLServerContainer<>(DockerImageName
////                .parse("testcontainers.mssql.container.image").asCompatibleSubstituteFor("mcr.microsoft.com/mssql/server"));
//
